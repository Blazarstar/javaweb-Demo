...
<table>
  ...
  <tr><td>性别:</td><td><input type="text" name="gender" size="20"/></td></tr>
  <tr><td>年龄:</td><td><input type="text" name="age" size="20"/></td></tr>
  <tr><td>邮箱:</td><td><input type="text" name="mail" size="20"/></td></tr>
